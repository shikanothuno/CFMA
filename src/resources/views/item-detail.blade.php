        ...
        <div class="container">
            ...
            <div class="item-detail-card">
                ...
                <div class="favorite-and-comment">
                    <table>
                        <tr>
                            ...
                            <td class="favorite-and-comment__td"><a href="{{ route('comment.view', $item) }}"><img
                                        class="icon" src="{{ asset('images/comment.png') }}" alt=""></a></td>
                        </tr>
                        <tr>
                ...
                <table>
                    <tr>
                        <td>
                            <h5 class="item-category">カテゴリー</h5>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <h5 class="item-status-text">商品の状態</h5>
                        </td>
                        <td>
                            <p class="item-status">{{ $item->item_status->item_status_name }}</p>
                        </td>
                    </tr>
                </table>
