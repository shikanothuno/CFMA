        ...
        <div class="container">
            ...
            <div class="form-div">
                <form action="{{ route('address.update.store') }}" method="post">
                    ...
                    <input class="input" type="text" id="zip-code" name="zip-code"
                        value="{{ old('zip-code', $user->user_zip_code) }}">
                    ...
                    <input class="input" type="text" id="building-name" name="building-name"
                        value="{{ old('building-name', $user->user_building_name) }}">
