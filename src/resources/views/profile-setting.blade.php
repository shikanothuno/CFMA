    ...
    <main>
        <div class="container">
            ...
            @foreach ($errors->all() as $error)
                <li>{{ $error }}</li>
            @endforeach
            <form class="input-form" action="{{ route('profile.setting.update') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="thumbnail-and-uplode-image">
                    <img class="thumbnail"
                        src="{{ is_null($user->image) ? asset('images/default.png') : asset($user->image->image_url) }}"
                        alt="">
                ...
                <div class="inputs">
                    ...
                    <input class="input" id="zip-code" name="zip-code" type="text"
                    ...
                    <input class="input" id="building-name" name="building-name" type="text"
                        value="{{ $user->user_building_name }}">
